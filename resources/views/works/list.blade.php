                            ...
                            <tbody>
                                <tr v-for="work in works">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-secondary" @click="erase(work.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    .then(res => {
                        ...
                        this.pages = Math.ceil(res.data.worksCount / res.data.dataAmount)
                ...
                erase(id){
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            this.loading = true
                            axios.post("{{ url('/works/delete/') }}", {id: id}).then(res => {
                                this.loading = false
