            ...
            methods:{
                ...
                update(){
                    ...
                    if(this.workImages.length > 0){
                        this.loading = true
                        axios.post("{{ url('/works/update') }}", {id: this.id,title:this.title, image: this.picture, workImages: this.workImages, description: this.description, clientName: this.clientName}).then(res => {
                            this.loading = false
