                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    <div class="col bg-white px-6 py-8 rounded-xl mr-7">
                                        ...
                                        <a href="#" class="text-info font-weight-bold font-size-h6">Ventas: {{ App\Payment::with("guestUser")
                                    ...
                                    <div class="col bg-white px-6 py-8 rounded-xl mr-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Productos: {{ App\Product::count() }}</a>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach(App\Payment::with("guestUser")
