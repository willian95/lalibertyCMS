                ...
                store(){
                    ...
                    if(this.pictureStatus == "listo"){
                        ...
                        if(this.description == ""){
                            ...
                            this.loading = true
                            axios.post("{{ url('/blogs/store') }}", {title:this.title, image: this.finalPictureName, description: this.description, createdDate: this.createdDate, mainImageFileType: this.mainImageFileType}).then(res => {
                            this.loading = false
