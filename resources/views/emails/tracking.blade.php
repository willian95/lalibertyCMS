                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="540" align="center" valign="top" style="padding:0;Margin:0;"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;font-size:0px;"><img class="adapt-img" src="https://www.laliberty.com.co/assets/img/logo1.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;object-fit: contain;" width="200" height="133"></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="padding:0;Margin:0;"><h1 style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#0c4572; margin-bottom: 80px;">Sigue tu orden copiando este número de seguimiento: {{ $tracking }} de la empresa: {{ $shippingProvider }} </h1></td> 

                      <tr style="margin-top: 120px;">
                        <td>Nombre: {{ $user->name }}</td>
                      </tr>
                      <tr>
                      <td>Total: $ {{ number_format($payment->total, 0, ",", ".") }}</td>
                      </tr>
                      <tr>
                     ...
                     <td align="left" style="Margin:0;padding-bottom:15px;padding-top:30px;padding-left:30px;padding-right:30px;border-radius:10px 10px 0px 0px;background-color:#FFFFFF;" bgcolor="#ffffff">
                      ...
                      <tr style="border: 1px solid black; border-collapse:collapse">
                        ...
                        <th style="border: 1px solid black;border-collapse:collapse">Articulo</th>
                        ...
                        <th style="border: 1px solid black;border-collapse:collapse">Color</th>
                      ...
                      @foreach($products as $product)
                        ...
                        <tr style="border: 1px solid black; border-collapse:collapse">
                            ...
                            <td style="border: 1px solid black; border-collapse:collapse; text-align:center"><img src="{{ $product['productColorSize']['product']['image'] }}" style="width: 60px;">
                            <p>{{ $product['productColorSize']['product']['name'] }}</p></td>
                            <td>1</td>
