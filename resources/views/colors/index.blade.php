                        ...
                        <table class="table">
                            <thead>
                                <tr >
                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">Color</span>
                                    </th>
                            ...
                            <tbody>
                                <tr v-for="color in colors">
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#formatModal" @click="edit(color)"><i class="far fa-edit"></i></button>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                store(){
                    ...
                    this.loading = true
                    axios.post("{{ url('color/store') }}", {name: this.name})
                    .then(res => {
                        this.loading = false
                ...
                update(){
                    ...
                    this.loading = true
                    axios.post("{{ url('color/update') }}", {id: this.formatId, name: this.name})
                    .then(res => {
                        this.loading = false
                        if(res.data.success == true){
                ...
                edit(color){
                    ...
                    this.formatId = color.id
                },
                fetch(page = 1){

                    this.page = page

                    axios.get("{{ url('color/fetch') }}"+"/"+page)
                    .then(res => {
